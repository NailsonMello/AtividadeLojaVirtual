...
<?php
	...
	$usuario = dbler('produtos','WHERE marca_produto = "not_positivo"'); //SE FOR COLOCAR A BUSCA POR CAMPOS
...
?>
	 <article class="servico">
	    ...
	    <a href="notebook/<?php echo $user['img_produto']; ?>"><img src="notebook/<?php echo $user['img_produto']; ?>" alt="Alcatel"></a>
	  <div class="inner">
